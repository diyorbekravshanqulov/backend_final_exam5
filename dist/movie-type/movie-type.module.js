...
const movie_type_controller_1 = require("./movie-type.controller");
const sequelize_1 = require("@nestjs/sequelize");
const movie_type_entity_1 = require("./model/movie-type.entity");
let MovieTypeModule = class MovieTypeModule {
};
exports.MovieTypeModule = MovieTypeModule;
exports.MovieTypeModule = MovieTypeModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([movie_type_entity_1.MovieType])],
