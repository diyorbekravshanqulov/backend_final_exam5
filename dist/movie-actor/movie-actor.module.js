...
const movie_actor_controller_1 = require("./movie-actor.controller");
...
exports.MovieActorModule = MovieActorModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([movie_actor_entity_1.MovieActor])],
        controllers: [movie_actor_controller_1.MovieActorController],
        providers: [movie_actor_service_1.MovieActorService],
    })
], MovieActorModule);
//# sourceMappingURL=movie-actor.module.js.map